...
import java.nio.file.Paths;
	...
	public class FileHandler {
		...
		private PatternFormatException error;
	 ...
	 */	
	public void readFromDisk(File file) throws Exception {
	...
	private String rleToString(String rleCode) {
